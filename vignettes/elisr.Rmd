...
the algorithm excludes those that are already built into a fragment. Later on,
we will talk about this inclusion criterion in greater detail. Making a long
story short: Using `overlap()` an item can appear in more than one of the
